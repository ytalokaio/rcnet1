...
-- Dump completed on 2016-01-07 18:25:32
...
CREATE TABLE `stg1_itens` (
  ...
  KEY `sku` (`CodigoBarra`)
) ENGINE=InnoDB AUTO_INCREMENT=24814 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 495616 kB; InnoDB free: 14336 kB; InnoDB free: ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stg_zcupomitensloja2` (
  ...
  KEY `2nd` (`CCF`),
  KEY `codigo_sku` (`Codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=23001 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
